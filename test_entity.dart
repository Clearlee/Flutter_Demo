class TestEntity {
	...
	TestEntity({this.msg, this.code, this.data, this.success});
...
class TestData {
	...
	TestData({this.startRow, this.navigatepageNums, this.prePage, this.hasNextPage, this.nextPage, this.pageSize, this.endRow, this.xList, this.pageNum, this.navigatePages, this.total, this.navigateFirstPage, this.pages, this.size, this.isLastPage, this.hasPreviousPage, this.navigateLastPage, this.isFirstPage});
	...
	TestData.fromJson(Map<String, dynamic> json) {
		...
		endRow = json['endRow'];
		if (json['list'] != null) {
			xList = new List<TestDataList>();(json['list'] as List).forEach((v) { xList.add(new TestDataList.fromJson(v)); });
		}
...
class TestDataList {
	...
	TestDataList({this.headImg, this.like, this.nickName, this.touristGuide, this.follows, this.certificateGrade, this.follow, this.userId, this.followEachOther, this.fans});
